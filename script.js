        ...
        let isMapExpanded = false; // 🔧 NOVO: Estado do mapa expandido
            ...
            return new Promise((resolve) => {
                setTimeout(() => {
                    try {
                        ...
                        // 🔧 RESTAURADO: Adicionar bolinhas de cidades
                        if (radioData.kmlPlacemarks && radioData.kmlPlacemarks.length > 0) {
        ...
        // 🔧 RESTAURADO: Função para adicionar bolinhas de cidades no mapa
        function addCityMarkersIndividual() {
            ...
            radioData.kmlPlacemarks.forEach((placemark, index) => {
                ...
                // 🔧 RESTAURADO: Mapear cidade para localização no mapa
        ...
        // 🔧 RESTAURADO: Adicionar bolinhas de cidades para proposta
